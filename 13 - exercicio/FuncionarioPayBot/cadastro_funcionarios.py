...
class App:
    ...
    def processar_pagamentos(self):
        ...
        for funcionario in self.funcionarios:
            salarios.append((funcionario.nome, funcionario.calcular_salario()))
        
        salarios_df = pd.DataFrame(salarios, columns=["Nome", "Salário"])
        salarios_df.to_csv("salarios.csv", index=False)
        messagebox.showinfo("Sucesso", "Pagamentos processados com sucesso! Salários salvos em salarios.csv")
